...
function SectionAnalysis() {
  ...
  return (
    <Grid container spacing={3}>
      <Grid item md={4}>
        <CardElem title="Données d'entrée" subtitle="Section: dimensions">
          <InputElem
            value={values.b}
            text={"b"}
            description={"Largeur:"}
      ...
      <Grid item md={4}>
        <CardElem title="Graphique" subtitle="Section">
          <ChartElem
            dataForChart={{
              ...
              axisName: {
                x: "Largeur de la Section ",
                y: "Hauteur de la section ",
              },
              unit: { x: "m", y: "m" },
            }}
          />
